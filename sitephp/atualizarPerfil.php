...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($usuario)) {
        ...
        // Verificar se a senha atual foi fornecida e está correta (obrigatório para qualquer atualização)
        if (empty($_POST['senha_atual'])) {
            $mensagem = "Por favor, informe sua senha atual para confirmar a atualização do perfil";
            $tipo_mensagem = "erro";
        } else {
        ...
        <div class="profile-container">
            ...
            <form action="atualizarPerfil.php" method="post">
                ...
                <div class="senha-section">
                    ...
                    <div class="form-group">
                        <label for="senha_atual">Senha Atual <span class="campo-obrigatorio">*Obrigatório para qualquer atualização</span></label>
